    ...
    <div className="max-w-4xl mx-auto px-4 py-6 space-y-8">
      <div className="bg-stone-50 border border-stone-200 rounded-2xl p-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-orange-600 text-white font-medium text-sm hover:bg-orange-700 disabled:opacity-50 disabled:cursor-not-allowed shadow-[...]"
          >
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
            <div className="relative flex-1">
              <input
                ...
                className="w-full pl-3.5 pr-20 py-2.5 text-sm font-mono bg-stone-50 border border-stone-300 rounded-xl text-stone-900 placeholder:text-stone-400 focus:outline-hidden focus:ring-2 focus:ring-orange-500"
              />
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl border border-stone-300 bg-stone-50 hover:bg-stone-100 text-stone-700 font-medium text-xs shadow-xs"
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl border border-stone-300 bg-stone-50 hover:bg-stone-100 text-stone-700 font-medium text-xs shadow-xs disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      <div className="bg-stone-900 text-stone-100 rounded-2xl p-6 shadow-sm space-y-4">
        ...
        <p className="text-xs text-stone-300 leading-relaxed">
          In your n8n workspace, press <kbd className="px-1.5 py-0.5 bg-stone-800 rounded font-mono text-[11px] text-orange-300">Ctrl+V</kbd> or <kbd className="px-1.5 py-0.5 bg-stone-800 rounded font-mono text-[11px] text-orange-300">⌘V</kbd> to import this workflow template.
        </p>
